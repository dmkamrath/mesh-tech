...
void UCylinderMeshGen::GenerateCylinder(UProceduralMeshComponent* Promesh)
{
	...
	float InHeight = 200;
	float InWidth = 100;
	int32 InCrossSectionCount = 10;
	bool bInCapEnds = true;
	bool bInDoubleSided = true;
	bool bInSmoothNormals = false;
	...
	Promesh->CreateMeshSection(0, Vertices, Triangles, Normals, UVs, VertexColors, Tangents, true);
}